...
export const mockTopPicksResult: MenuScanResult = {
  ...
  caution: [
    { name: 'Caesar Salad', shortReason: 'Ask for dressing on the side to keep calories in check.', pins: [], riskPins: ['High-calorie', 'High fat'], quickFix: 'Try: sauce on the side', confidencePercent: 65, dietBadges: [], allergenNote: null, noLine: null },
  ...
  avoid: [
    { name: 'Fettuccine Alfredo', shortReason: 'Very high calories and refined carbs.', pins: [], riskPins: ['High-calorie', 'High carbs'], confidencePercent: 85, dietBadges: [], allergenNote: null, noLine: null },
    { name: 'Deep-fried Combo', shortReason: 'Energy dense and heavy in trans fats.', pins: [], riskPins: ['Fried', 'High-calorie'], confidencePercent: 90, dietBadges: [], allergenNote: null, noLine: null },
  ],
